...
namespace MVC.Controllers
{
    public class Data
    {
        ...
        {
            new Student{Id = 501, Name = "Swastika Shrestha", Section = "B"},

            new Student{Id = 502, Name = "Sumee Tamang", Section = "A"},

            new Student{Id = 503, Name = "SudipRaj Shrestha", Section = "B"},

            new Student{Id = 504, Name = "Sujal Dangal", Section = "A"},

            new Student{Id = 505, Name = "Sneha Tuladhar", Section = "B"},
       };
